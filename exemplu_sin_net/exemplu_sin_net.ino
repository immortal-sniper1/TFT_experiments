...
// de aici  https://github.com/KrisKasprzak/GraphingFunction/blob/master/Graph.ino
...
void setup() {
  ...
  for (x = 0; x <= 6.3; x += .1) {
    ...
    y = sin(x);
    Graph(tft, x, y, 60, 150, 200, 130, 0, 6.5, 1, -1, 1, .25, "Sin Function", "x", "sin(x)", DKBLUE, RED, YELLOW, WHITE, BLACK, display1);
  ...
  for (x = 0; x <= 6.3; x += .1) {
    ...
    y = sin(x);
    Graph(tft, x, y, 100, 140,50, 120, 0, 6.5, 3.25, -1, 1, .25, "Sin Function", "x", "sin(x)", GREY, GREEN, RED, YELLOW, BLACK, display9);
  ...
  for (x = 0; x <= 25.2; x += .1) {
    ...
    y = sin(x);
    Graph(tft, x, y, 50, 100, 200, 60, 0, 25, 5, -1, 1, .5, "Sin Function", "x", "sin(x)", DKYELLOW, YELLOW, GREEN, WHITE, BLACK, display8);
  ...
  for (x = 0.001; x <= 10; x += .1) {
    ...
    y = log(x);
    Graph(tft, x, y, 50, 120, 150, 90, 0, 10, 1, -10, 5, 1, "Natural Log Function", "x", "ln(x)", BLUE, RED, WHITE, WHITE, BLACK, display2);
  ...
  for (x = 0; x <= 10; x += 1) {
    ...
    y = x * x;
    Graph(tft, x, y, 50, 150, 200, 130, 0, 10, 1, 0, 100, 10, "Square Function", "x", "x^2", DKRED, RED, YELLOW, WHITE, BLACK, display3);
  ...
  for (x = 0.00; x <= 20; x += .01) {
    ...
    Graph(tft, x, y, 50, 150, 200, 130, 0, 20, 1, -20, 20, 5, "Weird Function", "x", " y = sin(x) + cos(x) - log(x)", ORANGE, YELLOW, CYAN, WHITE, BLACK, display4);
  ...
  for (x = 0; x <= 12.6; x += .1) {
    ...
    y = sin(x);
    Graph(tft, x, y, 50, 200, 100, 100, 0, 13, 3.5, -1, 1, 1, "Sin(x)", "x", "sin(x)", DKBLUE, RED, YELLOW, WHITE, BLACK, display5);
  ...
  for (x = 0; x <= 6.3; x += .05) {
    ...
    y = cos(x);
    Graph(tft, x, y, 100, 200, 250, 150, 0, 6.5, 3.25, -1, 1, 1, "Cos Function", "x", "cos(x)", DKGREY, GREEN, BLUE, BLACK, WHITE, display6);
